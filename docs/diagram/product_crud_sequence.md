...
sequenceDiagram
    ...
    alt Create Product
        ...
        User->>UI: Nhập thông tin (tên, NCC,...) & nhấn "Tiếp tục"
    ...
    alt Read Product List
        ...
        Note right of Service: View này đã gộp sẵn Tồn kho (available_stock) và Giá bán (current_price) để tối ưu.
    ...
    alt Update Product
        User->>+UI: Mở "EditProductScreen" & sửa thông tin
        User->>UI: Nhấn "Lưu"
    ...
    alt Delete Product
        ...
        Note right of Service: Đây là xóa mềm (soft delete) để bảo toàn dữ liệu lịch sử.
