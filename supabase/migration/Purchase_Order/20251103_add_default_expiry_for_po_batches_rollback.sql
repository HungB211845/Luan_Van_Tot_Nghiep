-- File: supabase/migration/Purchase_Order/20251103_add_default_expiry_for_po_batches_rollback.sql
-- Purpose: restore create_batches_from_po() to version without default expiry date logic
...
BEGIN
  ...
  LOOP
    ...
    -- Create product batch (no default expiry date)
