-- =============================================================================
-- EXPORT SALES LEDGER RPC FUNCTION
-- =============================================================================
-- Creates RPC function to export detailed sales transactions for tax reporting
-- Returns structured data optimized for CSV export
-- =============================================================================
...
BEGIN
  ...
  SELECT
    ...
    COALESCE(p.unit, 'Cái') AS "Đơn vị tính",
...
COMMENT ON FUNCTION export_sales_ledger IS 'Exports detailed sales ledger for tax reporting. Returns transaction items with Vietnamese headers optimized for CSV export.';

-- =============================================================================
-- END OF EXPORT SALES LEDGER RPC FUNCTION
-- =============================================================================