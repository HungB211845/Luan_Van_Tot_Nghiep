...
-- Date: 2025-10-05
-- Purpose: Fix critical database issues causing Error 522/503 and deadlocks
...
-- Clear any stuck transactions (if possible)
SELECT pg_cancel_backend(pid)
FROM pg_stat_activity
WHERE state = 'active'
  AND query LIKE '%price_history%'
...
-- =============================================================================
-- STEP 4: RECREATE MISSING FUNCTION - update_product_selling_price
-- This function is called by Flutter app but may be missing
-- =============================================================================

-- Create/replace the missing function with proper error handling
...
GRANT EXECUTE ON FUNCTION update_product_selling_price(uuid, numeric, uuid, text) TO authenticated;

-- =============================================================================
-- STEP 5: CLEAR DATABASE CONNECTION ISSUES
-- Reset connection state and clear any hanging locks
-- =============================================================================

-- Terminate any long-running queries that might be causing issues
...
-- Final status check
SELECT
    '🎯 EMERGENCY FIXES APPLIED SUCCESSFULLY' as status,
    '✅ Removed deadlock trigger' as step1,
    '✅ Fixed expiring_batches view' as step2,
    '✅ Fixed low_stock_products view' as step3,
    '✅ Recreated update_product_selling_price function' as step4,
    '✅ Cleared stuck connections' as step5,
...
-- 1. Check Supabase dashboard for any remaining locks
-- 2. Restart Supabase project if necessary
-- 3. Verify RLS policies are not conflicting
--
-- =============================================================================