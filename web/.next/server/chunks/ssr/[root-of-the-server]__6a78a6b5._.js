...
const productService = {
    ...
    getByCompany: async (companyId)=>{
        ...
        if (!response.ok) {
            const errorData = await response.json().catch(()=>({}));
            throw new Error(errorData.error ?? 'Failed to fetch products by company');
        }
        return response.json();
    },
    getById: async (id)=>{
...
function useProducts() {
    ...
    const fetchProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            setLoading(true);
            setError(null);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$products$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["productService"].getAll();
            setProducts(data);
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6a78a6b5._.js.map